...
export default function SalesPage() {
  ...
  // Summary values — getSalesSummary already excludes cancelled sales at the backend
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                          <span className={cn('text-[10px] font-bold uppercase px-2 py-0.5 rounded-full border', STATUS_CLS[sale.status] ?? STATUS_CLS.completed)}>
                            {sale.status}
                          </span>
                      ...
                      <div className="text-right shrink-0">
                        ...
                        {sale.balance_due > 0 && !isCancelled && (
                          <p className="text-[10px] text-yellow-400 mt-0.5">{fmt(sale.balance_due)} due</p>
                        )}
                      </div>
